<script lang="ts">
  ...
  // If a user types /quests at a location that hasn't enabled the
  ...
  // Climbers who navigate to /quests at a disabled location get
  ...
  <header class="page-header">
    ...
    {#if enabled}
      <div class="header-actions">
        ...
        <a class="badges-link" href="/quests/badges">Badges →</a>
        <a class="badges-link" href="/quests/activity">Activity →</a>
      </div>
    {/if}
  </header>
  ...
  {:else if enabled === false}
    ...
    <div class="empty-card">
      ...
      <p>
        ...
        then flip the toggle in <a class="link" href="/settings/gym">gym settings</a>.
      </p>
    </div>
  {:else if error}
    ...
    {:else}
      ...
      <ul class="quest-grid">
        {#each visibleCatalog as q (q.id)}
          ...
          <li>
            <a class="quest-card" href="/quests/{q.id}">
      ...
      <section class="section">
        ...
        <ul class="quest-grid">
          {#each activeMine as cq (cq.id)}
            <li>
              <a class="quest-card" href="/quests/{cq.quest_id}">
                <div class="quest-head">
                  {#if cq.quest?.domain}
