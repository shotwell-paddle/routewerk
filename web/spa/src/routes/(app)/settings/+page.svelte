...
<div class="page">
  ...
  {#if roleRankAt(effectiveLocationId()) >= 3}
    <section class="card cta-card">
      ...
      <a class="primary-link" href="/settings/gym">Manage gym settings →</a>
    </section>
  {/if}
  ...
  {#if roleRankAt(effectiveLocationId()) >= 3}
    <section class="card cta-card">
      ...
      <a class="primary-link" href="/settings/progressions">Manage progressions →</a>
    </section>
  {/if}
  ...
  {#if roleRankAt(effectiveLocationId()) >= 3}
    <section class="card cta-card">
      ...
      <a class="primary-link" href="/settings/playbook">Edit playbook →</a>
    </section>
  {/if}
  ...
  {#if roleRankAt(effectiveLocationId()) >= 5}
    <section class="card cta-card">
      ...
      <a class="primary-link" href="/settings/org">Manage organization →</a>
    </section>
  {/if}
