...
<div class="page">
  <header class="page-header">
    ...
    {#if locId}
      <a class="btn-primary" href="/app/card-batches/new">+ New batch</a>
    {/if}
  </header>
  ...
  {:else if batches.length === 0}
    <div class="empty-card">
      ...
      <a class="btn-primary" href="/app/card-batches/new">Create batch</a>
    </div>
  {:else}
    <ul class="batch-list">
      {#each batches as b (b.id)}
        <li>
          <a class="batch-card" href="/app/card-batches/{b.id}">
