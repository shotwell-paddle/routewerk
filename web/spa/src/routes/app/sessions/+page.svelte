...
<div class="page">
  <header class="page-header">
    ...
    {#if locId}
      <a class="btn-primary" href="/app/sessions/new">+ New session</a>
    {/if}
  </header>
  ...
  {:else if sessions.length === 0}
    <div class="empty-card">
      ...
      <a class="btn-primary" href="/app/sessions/new">Create session</a>
    </div>
  {:else}
      ...
      {#if list.length > 0}
        <section class="group">
          ...
          <ul class="session-list">
            {#each list as s (s.id)}
              <li>
                <a class="session-card" href="/app/sessions/{s.id}">
